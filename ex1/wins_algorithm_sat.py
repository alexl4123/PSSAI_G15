...
def to_eulerian_proc(graph, oddVertices):
    ...
    endTime = time.time()
    formatted_float_value = "{:.4f}".format((endTime - startTime))
    print("<<TOTAL-TIME-FOR-SHORTEST-PATH: " + formatted_float_value + ">>>>>>>>>>>")
    ...
    print("CONSTRAINTS: ", solver.NumBooleans())
    print("VARIABLES: ", solver.NumBranches())
